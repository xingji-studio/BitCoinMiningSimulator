...
int main()
{
	...
	//read(xk, rmb, wh);
	cout << endl;
	cout << "欢迎来到挖矿模拟器1.6.6！为了您有着更好的体验，在使用之前请设置以下参数：" << endl;
	cout << "1.在多少项后暂停" << endl;
	cout << "2.语言" << endl;
	cout << "3.是否添加DLC" << endl;
	cout << "4.游玩的服务器" << endl;
	...
	else if (cel == 1)
	{
		...
		Sleep(500);
		cout << "|=========Mining Simulator 1.6.6==========|" << endl;
		cout << "|    P O W E R E D   B Y   X I N G J I    |" << endl;
		cout << "|             >>> loading <<<             |" << endl;
		Sleep(1500);
	}
	...
	while (true)
	{
			if (cel == 0)
			{
				cout << "*********************************************" << endl;
				cout << "*                                           *" << endl;
				cout << "*    挖矿模拟器 1.6.6 for XINGJI STUDIOS    *" << endl;
				cout << "*                                           *" << endl;
				cout << "*********************************************" << endl;
			...
			else if (cel == 1)
			{
				cout << "*******************************************************" << endl;
				cout << "*                                                     *" << endl;
				cout << "*      Mining simulator 1.6.6 for XINGJI STUDIOS      *" << endl;
				cout << "*                                                     *" << endl;
				cout << "*******************************************************" << endl;
			...
			if (in == 'E' || in == 'e')
			{
				...
				cout << "新邮件：停服公告" << endl;
				cout << "挖矿模拟器工作室" << endl;
				cout << "由于芦芦过生日加上维护时间已到，星际服务器将于10月1日至10月13日无法" << endl;
				cout << "游玩，感谢您的理解！谢谢！届时大家可以登录《挖矿模拟器》的离线模式进" << endl;
				cout << "行游玩。进入离线模式方法：在询问“请选择游玩的服务器”时输入“Z”进" << endl;
				cout << "入离线模式。" << endl;
				cin >> in;
				cout << "领取成功！！！" << endl;
				rmb = rmb + 290000;
		...
		if (c == 2)
		{
			...
			else if (in == 'C' || in == 'c')
			{
				if (cel == 0)
				{
					...
					cout << "  版本：1.6.6     编写器：Microsoft Visual Studio  " << endl;
				...
				else if (cel == 1)
				{
					...
					cout << "  Version:1.6.6    Writer:Microsoft Visual Studio  " << endl;
