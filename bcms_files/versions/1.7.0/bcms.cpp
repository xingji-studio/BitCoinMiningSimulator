...
int main()
{
	...
	read(rmb,s,xkm,xk);
	cout << endl;
	cout << "欢迎来到挖矿模拟器1.7.0！为了您有着更好的体验，在使用之前请设置以下参数：" << endl;
	cout << "1.在多少项后暂停" << endl;
	cout << "2.语言" << endl;
	cout << "3.是否添加DLC" << endl;
	cout << "4.游玩的服务器" << endl;
	...
	while (true)
	{
		...
		if (c == 2)
		{
			...
			{
				cout << "===================关于挖矿模拟器===================" << endl;
				cout << "应用及内核版本：挖矿模拟器1.7.0正式版-基于XG2.0内核" << endl;
				cout << "兼容性：适用于Windows8.1及以上版本操作系统的电脑版" << endl;
				cout << "开发商：中国星际国际科技有限公司(R)，保留所有权利。" << endl;
				cout << "支持的语言：中文、英语（已经于1.6.8停止继续更新翻译）" << endl;
				cout << "激活：已经由 星际集团有限公司 激活。激活号码：*****" << endl;
				cout << "====================================================" << endl;
