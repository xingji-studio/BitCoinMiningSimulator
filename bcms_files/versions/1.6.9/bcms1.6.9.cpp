...
int main()
{
	...
	//read(xk, rmb, wh);
	cout << endl;
	cout << "欢迎来到挖矿模拟器1.6.9！为了您有着更好的体验，在使用之前请设置以下参数：" << endl;
	cout << "1.在多少项后暂停" << endl;
	cout << "2.语言" << endl;
	cout << "3.是否添加DLC" << endl;
	cout << "4.游玩的服务器" << endl;
	...
	else if (cel == 1)
	{
		...
		Sleep(500);
		cout << "|=========Mining Simulator 1.6.9==========|" << endl;
		cout << "|    P O W E R E D   B Y   X I N G J I    |" << endl;
		cout << "|             >>> loading <<<             |" << endl;
		Sleep(1500);
	}
	...
	while (true)
	{
		...
		last_rmb = rmb;
			if (cel == 0)
			{
				cout << "*********************************************" << endl;
				cout << "*                                           *" << endl;
				cout << "*    挖矿模拟器 1.6.9 for XINGJI STUDIOS    *" << endl;
				cout << "*                                           *" << endl;
				cout << "*********************************************" << endl;
			...
			else if (cel == 1)
			{
				cout << "*******************************************************" << endl;
				cout << "*                                                     *" << endl;
				cout << "*      Mining simulator 1.6.9 for XINGJI STUDIOS      *" << endl;
				cout << "*                                                     *" << endl;
				cout << "*******************************************************" << endl;
		...
		if (c == 2)
		{
			...
			else if (in == 'C' || in == 'c')
			{
				if (cel == 0)
				{
					...
					cout << "  版本：1.6.9     编写器：Microsoft Visual Studio  " << endl;
				...
				else if (cel == 1)
				{
					...
					cout << "  Version:1.6.9    Writer:Microsoft Visual Studio  " << endl;
