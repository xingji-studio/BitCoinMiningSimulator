...
int main()
{
	...
	//read(xk, rmb, wh);
	cout << endl;
	cout << "欢迎来到挖矿模拟器1.6.4！为了您有着更好的体验，在使用之前请设置以下参数：" << endl;
	cout << "1.在多少项后暂停" << endl;
	cout << "2.语言" << endl;
	cout << "3.是否添加DLC" << endl;
	cout << "4.游玩的服务器" << endl;
	...
	else if (cel == 1)
	{
		...
		Sleep(500);
		cout << "|=========Mining Simulator 1.6.4==========|" << endl;
		cout << "|    P O W E R E D   B Y   X I N G J I    |" << endl;
		cout << "|             >>> loading <<<             |" << endl;
		Sleep(1500);
	}
	...
	while (true)
	{
			if (cel == 0)
			{
				cout << "*********************************************" << endl;
				cout << "*                                           *" << endl;
				cout << "*    挖矿模拟器 1.6.4 for XINGJI STUDIOS    *" << endl;
				cout << "*                                           *" << endl;
				cout << "*********************************************" << endl;
				cout << "      A.开始   B.退出   C.设置   D.商店      " << endl;
			}
			else if (cel == 1)
			{
				cout << "*********************************************" << endl;
				cout << "*                                           *" << endl;
				cout << "* Mining simulator 1.6.4 for XINGJI STUDIOS *" << endl;
				cout << "*                                           *" << endl;
				cout << "*********************************************" << endl;
				cout << " A.Start game   B.Exit   C.Settings   D.Shop " << endl;
			}
			cin >> in;
			if (in == 'A' || in == 'a')
			{
			...
			else if (in == 'D' || in == 'd')
			{
				...
				{
					cout << "抽奖" << endl;
					cout << "A.挖矿加成/技能卡抽奖   B.矿机抽奖" << endl;
					cin >> in;
					if (in == 'A' || in == 'a')
					{
						cout << "1000000￥抽一次" << endl;
						cout << "可以抽到的技能卡：【超级幸运】【挖矿升值】【无债务】【大量金钱】【时间加速】【挖矿掠夺】【星际祝福】【利息降低】" << endl;
						cout << "A.抽一次   B.不要抽" << endl;
						cin >> in;
						if (in == 'A' || in == 'a')
						{
							cout << "抽奖中......" << endl;
							...
							if (rmb <= 100 && rmb >= 0)
							{
								cout << "恭喜你获得了【大量金钱】技能卡！" << endl;
								cout << "介绍：【大量金钱】技能卡可以让你在十秒内获得大量金钱！" << endl;
								rmb = 12800000000;
								Sleep(1000);
							}
							else if (rmb <= 1000 && rmb > 100)
							{
								cout << "恭喜你获得了【超级幸运】技能卡！" << endl;
								cout << "介绍：【超级幸运】技能卡可以让你挖到矿的几率更高！" << endl;
								l = l / 9;
								Sleep(1000);
							}
							else if (rmb <= 10000 && rmb > 1000)
							{
								cout << "恭喜你获得了【时间加速】技能卡！" << endl;
								cout << "介绍：【时间加速】技能卡可以让你挖矿时间变得更短！" << endl;
								t = 0;
								Sleep(1000);
							}
							else if (l < 10)
							{
								cout << "恭喜你获得了【挖矿升值】技能卡！" << endl;
								cout << "介绍：【挖矿升值】技能卡可以让比特币价值翻倍！" << endl;
								b_yuan = b_yuan * 2;
								Sleep(1000);
							}
							else if (t > 1000 && t < 2000)
							{
								cout << "恭喜你获得了【挖矿掠夺】技能卡！" << endl;
								cout << "介绍：【挖矿掠夺】技能卡可以让你挖到的比特币数量翻倍！" << endl;
								s * 2;
								Sleep(1000);
							}
							else if (abs(um) > 1000000000 && abs(um) < 2000000000)
							{
								cout << "恭喜你获得了【无债务】技能卡！" << endl;
								cout << "介绍：【无债务】技能卡可以清空债务！" << endl;
								um = 0;
								Sleep(1000);
							}
							else if (abs(um) > 10000000000 && abs(um) < 20000000000)
							{
								cout << "恭喜你获得了【利息降低】技能卡！" << endl;
								cout << "介绍：【利息降低】技能卡可以让你债务的利息降低！" << endl;
								lx = lx / 2;
								Sleep(1000);
							}
							else if (rmb <= 1000000 && rmb >= 100000)
							{
								cout << "恭喜你获得了【星际祝福】技能卡！" << endl;
								cout << "介绍：【星际祝福】技能卡可以让你免费再抽十次！" << endl;
								rmb = rmb + 1000000;
								Sleep(1000);
							}
							else
		...
		if (c == 2)
		{
			if (cel == 0)
			{
				cout << "A.多少项后自动暂停   B.更新日志   C.关于   D.DLC导入   E.语言   F.贷款   G.挖矿模式   H.VIP   I.选区状态" << endl;
				cout << "A:" << wh << endl;
				cout << "请选择要更改的项目：";
			}
			else if (cel == 1)
			{
				cout << "A.How many entries are automatically paused after   B.Changelog   C.About   D.DLC import   E.Language   F.Loan   G.Mining mode   H.VIP   I.Selection status" << endl;
				cout << "A:" << wh << endl;
			...
			else if (in == 'B' || in == 'b')
			{
				if (cel == 0)
				{
					...
					cout << "·新增技能卡8张" << endl;
					cout << "·新增技能卡加成功能" << endl;
					cout << "·新增抽奖功能（暂未完善，第二部分将于英文更新第二部分（1.6.5）一起更新）" << endl;
					...
					cout << endl;
					cout << "================ 更  新  预  告 ================" << endl;
					cout << "1.6.5 、 1.6.6 、 1.6.7 和 1.6.8更新预告 - 语言更新" << endl;
					cout << "·完善了英语（1.6.5【第三阶段】）" << endl;
					cout << "·新增了俄语（1.6.6【第一阶段】、1.6.7【第二阶段】、1.6.8【第三阶段】）" << endl;
				}
				else if (cel == 1)
				{
					cout << "================ XINGJI Update ================" << endl;
					...
					cout << "· New sweepstakes feature (not yet perfect, part 2 will be updated in English with part 2 (1.6.5))" << endl;
					...
					cout << endl;
					cout << "================ Newer Forecast ================" << endl;
					cout << "1.6.4, 1.6.5, 1.6.6 and 1.6.7 Update Trailer - Language Update" << endl;
					cout << "·Improved English (1.6.4 [Phase III])" << endl;
					cout << "·Added Russian (1.6.5 [Phase I], 1.6.6 [Phase II], 1.6.7 [Phase III])" << endl;
				}
			}
			else if (in == 'C' || in == 'c')
			{
				if (cel == 0)
				{
					...
					cout << "  版本：1.6.4     编写器：Microsoft Visual Studio  " << endl;
					cout << "  开发商：XINGJI(R) Co.Inc.                        " << endl;
					cout << "  编号：" << key << "                        大小：2.83MB  " << endl;
				...
				else if (cel == 1)
				{
					...
					cout << "  Version:1.6.4    Writer:Microsoft Visual Studio  " << endl;
			...
			{
				cout << "当前选区：" << ms_server << endl;
				cout << "服务器状态：正常" << endl;
				cout << "服务器位置：北京" << endl;
				cout << "服务器OS版本：Windows10" << endl;
				cout << "服务端版本：0.2.7.137462" << endl;
				cout << "客户端版本：1.6.4.216041（正式版本）" << endl;
				cout << "编写器版本：Microsoft VS 2022-17.2.5" << endl;
				cout << "原文件大小：1347行（36.5KB）" << endl;
				cout << "应用程序大小：2.84MB" << endl;
				cout << "上一个版本：1.6.4.116041（16w04a）" << endl;
				cout << "下一个版本：1.6.5.116051（16w05a）" << endl;
				cout << "上一个非测试版本：1.6.3.216031" << endl;
				cout << "下一个非测试版本：1.6.5.216051" << endl;
			}
		}
		while (c == 1)
		{
