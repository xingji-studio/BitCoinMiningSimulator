...
int main()
{
	...
	//read(xk, rmb, wh);
	cout << endl;
	cout << "欢迎来到挖矿模拟器1.6.7！为了您有着更好的体验，在使用之前请设置以下参数：" << endl;
	cout << "1.在多少项后暂停" << endl;
	cout << "2.语言" << endl;
	cout << "3.是否添加DLC" << endl;
	cout << "4.游玩的服务器" << endl;
	...
	while (true)
	{
			if (cel == 0)
			{
				cout << "*********************************************" << endl;
				cout << "*                                           *" << endl;
				cout << "*    挖矿模拟器 1.6.7 for XINGJI STUDIOS    *" << endl;
				cout << "*                                           *" << endl;
				cout << "*********************************************" << endl;
		...
		if (c == 2)
		{
			if (cel == 0)
			{
				cout << "A.多少项后自动暂停   B.更新日志   C.关于   D.DLC导入   E.语言   F.贷款   G.挖矿模式   H.VIP   I.兑换码" << endl;
				cout << "A:" << wh << endl;
				cout << "请选择要更改的项目：";
			}
			else if (cel == 1)
			...
			else if (in == 'C' || in == 'c')
			{
				if (cel == 0)
				{
					...
					cout << "  版本：1.6.7     编写器：Microsoft Visual Studio  " << endl;
